...
import com.wudoumi.batter.volley.ParseError;
...
public class JsonObjectRequest extends JsonRequest<JSONObject> {
     ...
     *
     * @see #JsonObjectRequest(int, String, org.json.JSONObject, com.wudoumi.batter.volley.Response.Listener, com.wudoumi.batter.volley.Response.ErrorListener)
     */
    public JsonObjectRequest(String url, JSONObject jsonRequest, Listener<JSONObject> listener,
            ErrorListener errorListener) {
        this(jsonRequest == null ? RequestType.GET : RequestType.POST, url, jsonRequest,
