...
import cn.fetech.sanyi.adapter.ContractJieSuanAdapter;
 ...
 */
public class ContractJiesuanFragment extends BatterLoadingFragment implements PullToRefreshLayout.OnRefreshListener {


    public ContractJiesuanFragment() {
    ...
    private List<ContractJieSuan> list = new ArrayList<>();


    private ContractJieSuanAdapter adapter;
    ...
    protected void initData() {
        ...
        adapter = new ContractJieSuanAdapter(list,getActivity());
    ...
    private void doRequest(BatterLoadResponseListner responseListner){
        BatterTaskItem batterTaskItem = new BatterTaskItem(responseListner, new DoWork() {
            ...
            public boolean doWorkInThread() {
                ...
                list.addAll(TestData.createHetongJisuan());
                return true;
            }
        });
