...
import cn.fetech.sanyi.activity.AddQingjiadanActivity;
import cn.fetech.sanyi.adapter.QingjiadanAdapter;
 ...
 */
public class QingjiadanFragment extends BatterLoadingFragment implements PullToRefreshLayout.OnRefreshListener{


    public QingjiadanFragment() {
    ...
    private List<Qingjiadan> list = new ArrayList<>();


    private QingjiadanAdapter adapter;


    @Override
    protected int getLayoutId() {
        return R.layout.fragment_qingjiadan;
    }
    ...
    protected void initData() {
        ...
        adapter = new QingjiadanAdapter(list,getActivity());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),AddQingjiadanActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==123&&resultCode== Activity.RESULT_OK&&data!=null){
            Qingjiadan qingjiadan = (Qingjiadan) data.getSerializableExtra("qingjiadan");
            list.add(0,qingjiadan);
    ...
    private void doRequest(BatterLoadResponseListner responseListner){
        BatterTaskItem batterTaskItem = new BatterTaskItem(responseListner, new DoWork() {
            ...
            public boolean doWorkInThread() {
                ...
                list.addAll(TestData.createQingjiadans());
                return true;
            }
        });
